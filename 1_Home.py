...
def main():
    ...
    st.write(" Our trainer is perfect for both beginners and experienced users who want to deepen their understanding of digital communication systems. You will learn how to use Python libraries such as NumPy, SciPy, and Matplotlib to simulate and visualize digital communication systems.")
